...
// Transpiles imported *.inline.ts files to minified browser ESM (stripping all
// TypeScript syntax) and returns them as text so they can be embedded as inline
// JSResource scripts. Mirrors the official quartz-community plugin template.
